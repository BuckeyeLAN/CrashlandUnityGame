...
public class AncientBattlefield : Tile
{
    public override int count { get { return 2; } set { } }
    public override string description { get { return "Incur 1 disaster if you end your turn here; Discover 1 card"; } set { } }
    public override int discover_count { get { return 1; } set { } }
    public override int disaster_count_on_end { get { return 1; } set { } }
