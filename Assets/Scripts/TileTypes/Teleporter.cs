...
public class Teleporter : Tile
{
    ...
    public override string description { get { return "May spend 1 movement to move to another teleporter"; } set { } }
    public override int discover_count { get { return 0; } set { } }
    ...
    public override bool is_teleporter { get { return true; } set { } }
